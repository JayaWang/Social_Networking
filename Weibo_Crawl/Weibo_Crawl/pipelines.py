        ...
        if isinstance(item, WeiboTargetItem):
            try:
                if item["Tweet_Over"] == 'N':
                    sql = """insert into Tweet (Target_ID, Target_Name, Tweet_Time, Tweet_Content, Tweet_Transfer, Tweet_Liked, Tweet_Comment, Tweet_Platform, Tweet_GPS, Comment_Urls, Update_Time, Tweet_Over) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")"""%(item["Target_ID"], item["Target_Name"], item["Tweet_Time"], item["Tweet_Content"], item["Tweet_Transfer"], item["Tweet_Liked"], item["Tweet_Comment"], item["Tweet_Platform"], item["Tweet_GPS"], item["Comment_Urls"], item["Update_Time"], item["Tweet_Over"])
                else:
                    sql = """update Tweet set Target_ID = %s, Target_Name = %s, Tweet_Time = %s, Tweet_Content = %s, Tweet_Transfer = %s, Tweet_Liked = %s, Tweet_Comment = %s, Tweet_Platform = %s, Tweet_GPS = %s, Comment_Urls = %s, Update_Time = %s, Tweet_Over = %s"""%(item["Target_ID"], item["Target_Name"], item["Tweet_Time"], item["Tweet_Content"], item["Tweet_Transfer"], item["Tweet_Liked"], item["Tweet_Comment"], item["Tweet_Platform"], item["Tweet_GPS"], item["Comment_Urls"], item["Update_Time"], item["Tweet_Over"])+ """ where Target_ID = """ + item["Target_ID"]
